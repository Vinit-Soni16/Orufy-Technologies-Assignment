...
const Login = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    const isPhone = /^\+?\d{10,15}$/.test(val.replace(/\D/g, ''));
        ...
        <div className="w-full max-w-md">
          ...
          {step === 'email' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              {devOtp && (
                <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4 rounded-r shadow-sm animate-in fade-in slide-in-from-top-2">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-amber-700 mt-1">
                        Email/SMS service not configured.
                      </p>
